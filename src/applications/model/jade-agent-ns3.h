...
#ifndef JADE_AGENT_NS3_H
#define JADE_AGENT_NS3_H
 ...
 */
class JadeAgent : public Application
{
public:
...
private:
  ...
  //uint32_t m_sent;
  Ptr<Socket> m_socket;
  map<Address> m_peersAddress;
  //Address m_peerAddress;
  map<uint32_t> m_peersPort;
  //uint16_t m_peerPort;
  //EventId m_sendEvent;
